...
//		blocks.add(Map.entry(0xDBDAD5, new ColumnSideBlock("birch_log")));
		blocks.add(Map.entry(0x3C2F1A, new ColumnSideBlock("dark_oak_log")));
		blocks.add(Map.entry(0x3B2611, new ColumnSideBlock("spruce_log")));
		blocks.add(Map.entry(0x554419, new ColumnSideBlock("jungle_log")));
		blocks.add(Map.entry(0x676157, new ColumnSideBlock("acacia_log")));
		blocks.add(Map.entry(0x6D5533, new ColumnSideBlock("oak_log")));
		blocks.add(Map.entry(0x442D16, new ColumnEndBlock("dark_oak_log")));
		blocks.add(Map.entry(0x6E5230, new ColumnEndBlock("spruce_log")));
		blocks.add(Map.entry(0x9B7D4B, new ColumnEndBlock("oak_log")));
		...
		blocks.add(Map.entry(0xC6B177, new ColumnSideBlock("stripped_birch_log",    V1_13)));
		blocks.add(Map.entry(0x493924, new ColumnSideBlock("stripped_dark_oak_log", V1_13)));
		blocks.add(Map.entry(0x745A35, new ColumnSideBlock("stripped_spruce_log",   V1_13)));
		blocks.add(Map.entry(0xAC8555, new ColumnSideBlock("stripped_jungle_log",   V1_13)));
		blocks.add(Map.entry(0xB05D3C, new ColumnSideBlock("stripped_acacia_log",   V1_13)));
		blocks.add(Map.entry(0xB39157, new ColumnSideBlock("stripped_oak_log",      V1_13)));
		blocks.add(Map.entry(0xC0AD76, new ColumnEndBlock("stripped_birch_log",    V1_13)));
		blocks.add(Map.entry(0x432C16, new ColumnEndBlock("stripped_dark_oak_log", V1_13)));
		blocks.add(Map.entry(0x6C5230, new ColumnEndBlock("stripped_spruce_log",   V1_13)));
		blocks.add(Map.entry(0xA67A52, new ColumnEndBlock("stripped_jungle_log",   V1_13)));
		blocks.add(Map.entry(0xA75B33, new ColumnEndBlock("stripped_acacia_log",   V1_13)));
		blocks.add(Map.entry(0xA2834E, new ColumnEndBlock("stripped_oak_log",      V1_13)));
...
//		blocks.add(Map.entry(0x373738, new Block("chiseled_deepslate", V1_17))); // duplicate
		...
		blocks.add(Map.entry(0x544329, new ColumnSideBlock("mangrove_log", V1_19)));
		blocks.add(Map.entry(0x682F2A, new  ColumnEndBlock("mangrove_log", V1_19)));
	...
	private static BufferedImage resizeIfNecessary(BufferedImage image, Context context, String imagePath, int width, int height, int maxVerticalHeight) {
		...
		if(context.structureType == StructureType.BLOCK && imgWidth != imgHeight) {
		...
		} else if(context.structureType == StructureType.SKIN &&
